...
def build_seed_trips() -> list[Trip]:
    """The starter rows for an empty database. Returns ORM objects; services.py
    sets each trip's position and commits them. Called once on first run.
    """
    return [
        ...
        Trip(
            ...
            likes=142,
            comments=[
                Comment(author="Alice", body="Did this last spring - second the Trastevere walk.", posted_at="3 weeks ago"),
                Comment(author="Bob", body="Add the Appian Way at sunset, it's quiet.", posted_at="2 weeks ago"),
            ],
            highlights=[
        ...
        Trip(
            ...
            likes=201,
            comments=[
                Comment(author="Bob", body="Get there before 7am if you want a photo without crowds.", posted_at="1 month ago"),
            ],
            highlights=[
        ...
        Trip(
            ...
            likes=88,
            comments=[
                Comment(author="Carla", body="Sintra deserves two days, not one.", posted_at="2 months ago"),
            ],
            highlights=[
        ...
        Trip(
            ...
            likes=38,
            comments=[
                Comment(author="Bob", body="Which trattoria? I need a name.", posted_at="1 day ago"),
                Comment(author="Carla", body="27 plates is goals.", posted_at="1 day ago"),
                Comment(author="Alex", body="Saving this for my October trip.", posted_at="12 hours ago"),
            ],
        ),
        ...
        Trip(
            ...
            likes=124,
            comments=[
                Comment(author="Alice", body="Stunning. Which cafe?", posted_at="4 days ago"),
            ],
        ),
        ...
        Trip(
            ...
            likes=211,
            comments=[
                Comment(author="Bob", body="Did you do the eastfjords? Underrated.", posted_at="3 weeks ago"),
                Comment(author="Davide", body="Yes, two days there. Stunning.", posted_at="3 weeks ago"),
            ],
        ),
